...
export const CAPACITIES = [
  ...
  "Contrôle | héros - salopard - patron - autre | À portée longue ou inférieure, le PNJ peut faire agir une méta-armure à sa guise (la faire se déplacer, tirer, combattre, etc.). Seule une réussite sur un test base Hargne ou Tech- nique difficulté difficile (6) peut éviter à un personnage de se faire posséder. Activer cette capacité compte pour une action de n’importe quel type.",
  ...
  "Méta-armure (4 points d’aspect exceptionnel et 1 à 3 modules standards) | recrue - hostile - salopard - colosse - patron - autre | Le PNJ bénéfinie d'aspects exceptionnels et de modules jusqu'à standard de l'arsenal. Si les PA du PNJ tombent à 0, ces bénéfices sont annulés, jusqu'à ce que l'armure soit réparée.",
  "Méta-armure (8 points d’aspect exceptionnel et 1 à 3 modules avancés) | initié - hostile - salopard - colosse - patron - autre | Le PNJ bénéfinie d'aspects exceptionnels et de modules jusqu'à avancé de l'arsenal. Si les PA du PNJ tombent à 0, ces bénéfices sont annulés, jusqu'à ce que l'armure soit réparée.",
  "Méta-armure (12 points d’aspect exceptionnel et 1 à 3 modules rares) | héros - hostile - salopard - colosse - patron - autre | Le PNJ bénéfinie d'aspects exceptionnels et de modules jusqu'à rare de l'arsenal. Si les PA du PNJ tombent à 0, ces bénéfices sont annulés, jusqu'à ce que l'armure soit réparée.",
...
export const EFFECTS = [
  ...
  "Lumière 2 | recrue - hostile - salopard - colosse - patron - autre - autre - bande | 5",
  "Lumière 4 | initié - hostile - salopard - colosse - patron - autre - autre - bande | 15",
  "Lumière 6 | héros - hostile - salopard - colosse - patron - autre - autre - bande | 20",
