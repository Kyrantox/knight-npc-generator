...
export const CAPACITIES = [
  ...
  "Né dans a lumière | recrue - hostile - salopard - colosse - patron | Tous les dégâts infligés par le PNJ à un PJ sont retirés aux points d'espoir et non aux points de santé ou points d'armure.",
